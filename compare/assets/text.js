...
export default class GameText extends Hilo.Text {
  ...
  constructor (properties) {
    ...
    const fontFamily = properties.fontFamily + (properties.fontFamily ? ',' : '') + ' Microsoft Yahei, Helvetica Neue, Helvetica, Arial, Hiragino Sans GB, Heiti SC, WenQuanYi Micro Hei, sans-serif'
