...
export default class Panel extends Hilo.Container {
  ...
  switchQuestion() {
    ...
    var maxHeight = this._tool.planetInfo[0].height
    for (let i = 30; i < 100; i++) {
      if (this._tool.planetInfo[0].height > maxHeight) {
        this._tool.planetInfo[0].textHeight = i - 2
        this._tool.planetInfo[0]._fontHeight = i - 2
        this._tool.planetInfo[0].font =
          'normal bold ' +
          (i - 2) +
          'px/' +
          (i - 2) +
          'px Helvetica Neue, Helvetica, Arial, Microsoft Yahei,Hiragino Sans GB, Heiti SC, WenQuanYi Micro Hei, sans-serif'
        this._tool.planetInfo[1].textHeight = i - 2
        this._tool.planetInfo[1]._fontHeight = i - 2
        this._tool.planetInfo[1].font =
          'normal bold ' +
          (i - 2) +
          'px/' +
          (i - 2) +
        ...
        this._tool.planetInfo[0].textHeight = i
        this._tool.planetInfo[0]._fontHeight = i
        this._tool.planetInfo[0].font =
          'normal bold ' +
          i +
          'px/' +
    ...
    for (let i = 30; i < 100; i++) {
      if (this._tool.planetInfo[1].height > maxHeight) {
        this._tool.planetInfo[1].textHeight = i - 2
        this._tool.planetInfo[1]._fontHeight = i - 2
        this._tool.planetInfo[1].font =
          'normal bold ' +
        ...
        this._tool.planetInfo[1].textHeight = i
        this._tool.planetInfo[1]._fontHeight = i
        this._tool.planetInfo[1].font =
          'normal bold ' +
          i +
          'px/' +
